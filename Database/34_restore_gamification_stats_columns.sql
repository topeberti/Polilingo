-- ============================================================================
-- RESTORE USER GAMIFICATION STATS COLUMNS
-- ============================================================================
...
-- 2. Update Trigger Function to track questions and correct answers
...
BEGIN
    ...
    ELSIF TG_TABLE_NAME = 'user_lessons_history' AND NEW.passed = true THEN
        -- Only process if it's a new pass (Insert or status change)
