...
const ConceptFilter = (props: any) => (
    <Filter {...props}>
        ...
        <ReferenceInput source="heading_id" reference="headings" alwaysOn>
...
export const ConceptList = () => (
    <List filters={<ConceptFilter />} actions={<ConceptListActions />}>
        <Datagrid rowClick="edit">
            <TextField source="id" />
            <TextField source="name" />
            <ReferenceField source="heading_id" reference="headings" />
